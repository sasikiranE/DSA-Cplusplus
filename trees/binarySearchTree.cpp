...
private:
    ...
    bool equals(Node *root1, Node *root2) {
        ...
        if (root1 != NULL and root2 != NULL) {
            return root1->data == root2->data and equals(root1->left, root2->left) and
    ...
    bool isBinarySearchTree(Node *root, int low, int high) {
        ...
        if (root->data < low or root->data > high) {
            ...
            return isBinarySearchTree(root->left, low, root->data - 1) and
                   isBinarySearchTree(root->right, root->data + 1, high);
        }
    }
